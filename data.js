...
window.MOUNTAIN_DATA = {
  ...
  /* ---------- РЕКОМЕНДОВАНІ МАРШРУТИ ----------
     image — шлях до картинки. Фото маршрутів лежать у teці images/routes/.
     Щоб поставити реальне фото: поклади файл у images/routes/ і вкажи його
     тут, напр. "images/routes/parashka.jpg".
     Після додавання нового файлу — впиши його і в масив ASSETS у sw.js. */
  routes: [
    {
      name: "Гора Парашка",
