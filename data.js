...
window.MOUNTAIN_DATA = {
  ...
  gear: {
    1: [
      ...
      {
        cat: "Основне",
        items: ["Рюкзак", "Raincover (накидка від дощу на рюказак)"],
      },
      {
        cat: "Кухня",
    ...
    2: [
      { cat: "Must have", must: true, items: ["Гроші", "Документи", "Квитки"] },
      {
        ...
        items: [
          ...
          "Футпрінт",
          "Рюкзак",
          "Raincover (накидка від дощу на рюкзак)",
          "Спальник",
          "Каримат",
      ...
      },
      {
        ...
        items: [
          "Футболка — 1 (на собі)",
          "Термуха — 1 (на ніч)",
          "Шкарпетки — 2 (на собі + наступний день)",
          "Труси — 2 (на собі + наступний день)",
          "Шорти (на собі вдень)",
          "Фліс кофта (на вечір)",
          "Штани (на ніч)",
          "Вітровка (на вечір)",
      ...
      },
      {
        ...
        items: [
          ...
          { n: "Окуляри", opt: true },
          { n: "Стілець / Піддупник", opt: true },
          { n: "Сокира для дров(мала)", opt: true },
          { n: "Гамак", opt: true },
      ...
      },
      {
        ...
        items: [
          ...
          { n: "Горішки", opt: true },
          { n: "Сардельки / курка (засмажити на вогні)", opt: true },
        ],
      },
      {
        cat: "Зима / весна / осінь",
